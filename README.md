...
1. 有一些毕业于武汉外国语学校的人士表示肖某某在初高中时期在学业和个人生活方面有不良表现，这类信息例如一张关于 2021 年 1 月 21 日有男生闯入女厕所的告示等。从[这条微博](https://weibo.com/7925824471/PFqQw8SPj)及其所关联的一系列微博来看，这些信息发布者大多数可以证实是毕业于武汉外国语学校，而非冒充者。这些信息的内容可以得到一定程度的交叉验证。但同时一审判决书中有“中学推荐表……与本案争议焦点无关，本案不予采信”等表述，作者认为这些表述合理，关于肖某某中学的表现信息仅能作为辅助。关于肖某某的家庭背景的其他传言，除了本列表第 4 项可以得到交叉验证外，其他传言也一律不采信。

    1. 基于同样的信源鉴别标准，信源 1.2 中关于肖某某家教严格、害怕冲突、不善处事的表述是否符合事实也值得商榷。

2. 有一些自称武汉大学外国语言文学学院在读的人士表示肖某某的课堂表现是开朗自信的（此处指的不是 4.1 所述的 AI 生成的内容），这些信息的发布者尚未证实自己的身份，作者认为证据不足。有自称武汉大学在读或毕业的人士表示杨某某曾经污蔑过自己进行性骚扰，该信息的发布者尚未证实自己的身份，作者认为证据不足。
